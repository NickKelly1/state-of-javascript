...
export type IUserDataLoader = Dataloader<UserId, UserModel>;
export type IUserRoleDataLoader = Dataloader<UserRoleId, UserRoleModel>;
export type IRoleDataLoader = Dataloader<RoleId, RoleModel>;
export type IRolePermissionDataLoader = Dataloader<RolePermissionId, RolePermissionModel>;
export type IPermissionDataLoader = Dataloader<PermissionId, PermissionModel>;
...
export class Loader {
  ...
  public get users(): IUserDataLoader {
    ...
    this._users = new Dataloader(async (keys): Promise<(Error | UserModel)[]> => {
      const { runner } = this;
  ...
  public get roles(): IRoleDataLoader {
    ...
    this._roles = new Dataloader(async (keys): Promise<(Error | RoleModel)[]> => {
      const { runner } = this;
  ...
  public get userRoles(): IUserRoleDataLoader {
    ...
    this._userRoles = new Dataloader(async (keys): Promise<(Error | UserRoleModel)[]> => {
      const { runner } = this;
  ...
  public get permissions(): IPermissionDataLoader {
    ...
    this._permissions = new Dataloader(async (keys): Promise<(Error | PermissionModel)[]> => {
      const { runner } = this;
  ...
  public get rolePermissions(): IRolePermissionDataLoader {
    ...
    this._rolePermissions = new Dataloader(async (keys): Promise<(Error | RolePermissionModel)[]> => {
      const { runner } = this;
